...
\newcommand{\umbclogo}{%
        ...
        \selectfont%
        \makebox[0pt][l]{\raisebox{-0.20ex}[0pt][0pt]{\color{shadowcolorA}\hspace*{.20ex}IGSP/ISDS}}%
        \makebox[0pt][l]{\raisebox{-0.10ex}[0pt][0pt]{\color{shadowcolorB}\hspace*{.10ex}IGSP/ISDS}}%
        {\blue IGSP/ISDS}\hspace{.20ex}%
}}
